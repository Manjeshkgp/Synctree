...
const Signupclient = () => {
  ...
  return (<div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
  ...
  <form onSubmit={(e)=>{e.preventDefault();}} className="mt-8">
    <div className="space-y-5">
      ...
      <div>
        <label
          htmlFor="password"
          className="text-base font-medium text-gray-900 dark:text-gray-200 flex justify-start gap-x-4 items-center"
        >
          {' '}
          Password{' '}
          <button onClick={()=>setHide(!hide)}>{hide?<FiEyeOff/>:<FiEye/>}</button>
        </label>
        <div className="mt-2.5">
          <input
            className="flex h-10 w-full rounded-md border border-gray-300 bg-transparent py-2 px-3 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-700 dark:text-gray-50 dark:focus:ring-gray-400 dark:focus:ring-offset-gray-900"
